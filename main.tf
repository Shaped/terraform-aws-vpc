...
resource "aws_route" "eks_ipv6_egress" {
  count = local.create_vpc && var.create_egress_only_igw && var.enable_ipv6 && var.create_eks_subnet_route_table && length(var.eks_subnets) > 0 && var.create_eks_internet_gateway_route ? 1 : 0
